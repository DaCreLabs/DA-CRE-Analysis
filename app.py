...
# DACRE browser/page icon.
# Use the supplied DACRE logo first, then the supplied favicon, then a safe emoji.
try:
    if DACRE_LOGO_PATH.is_file():
        _DACRE_PAGE_ICON = str(DACRE_LOGO_PATH)
    elif DACRE_FAVICON_PATH.is_file():
        _DACRE_PAGE_ICON = str(DACRE_FAVICON_PATH)
    else:
        _DACRE_PAGE_ICON = "📊"
except Exception:
    _DACRE_PAGE_ICON = "📊"
