...
def ensure_runtime_schema():
    ...
    # The migration is schema-driven rather than version-driven: inspect the actual
    # tables so older call_rooms schemas are repaired safely.
    if using_cloud_db():
        return True
    max_attempts = 8
